...
<%@ Import Namespace="Hedgehog.Web.Controllers" %>
    ...
    <p>
        ...
        <ol>
            <li>
                ...
                within Hedgehog.Web/NHibernate.config</span>
	        </li>
            <li>
                Optionally, modify the Fluent NHibernate preferences within Hedgehog.Data.NHibernateMaps.GetConventions() 
            ...
            <li>
                Open Hedgehog.Tests.dll via NUnit and make sure all the tests are turning green.
	        </li>
            <li>
                ...
                Hedgehog.Web.Controllers.RouteRegistrar.RegisterRoutesTo() after the scaffolding generator has completed.)
	        </li>
        </ol>
    </p>
    <p>
