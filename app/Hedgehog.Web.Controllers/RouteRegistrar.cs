...
namespace Hedgehog.Web.Controllers
{
    public class RouteRegistrar
    {
        public static void RegisterRoutesTo(RouteCollection routes)
        {
            ...
            //routes.CreateArea("Organization/Department", "Hedgehog.Web.Controllers.Organization.Department",
            ...
            //);
            //routes.CreateArea("Organization", "Hedgehog.Web.Controllers.Organization",
            ...
            routes.CreateArea("Root", "Hedgehog.Web.Controllers",
